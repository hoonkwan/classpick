...
/* ============================================================
 * 클래스픽 입점 학원 화이트리스트 게이트
 * 현재 유일 입점 학원: 교육인학원. 시트에 다른 학원/강사 데이터가 남아 있어도
 * sync 결과에는 절대 들어오지 않음. 화이트리스트 강사 외 강좌는 시트 단계에서 폐기.
 * 신규 입점 학원이 추가되면 이 화이트리스트도 함께 확장.
 * ============================================================ */
...
const PREFIX_TAGS = {
  ...
  // 입점 학원 시트 prefix 매핑 (센텀점·사직점 / 방학특강). 신규 입점 시 확장.
